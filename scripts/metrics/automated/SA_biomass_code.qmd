...
for (file in files) {
  ...
  plot<-IEAnalyzeR::plot_fn_obj(df_obj = dat, manual_title = paste0(Species, " ", Assessment, " ", "Biomass"), trend = TRUE)
  
  file_name = paste0(Species, "_", Assessment, "_", "Biomass_plot.png")
  ggsave(plot, file = file.path(output_data_folder, file_name))
